...
$apppage = "https://".$_SERVER['SERVER_ADDR'].":8050/";
...
$portscansite = "http://mxtoolbox.com/SuperTool.aspx?action=https%3a".$publicip."%3a8050&run=toolpage";
    ...
    <div class="panel panel-default">
      ...
      <div id="descriptionbody" class="panel-collapse collapse in">
        <div class="panel-body">
          <p>This DroboApp deploys Pydio (formerly AjaXplorer) on your Drobo.</p>
          <p>Pydio is a mature open source software solution for file sharing and synchronization. Pydio offers web, mobile, and desktop user interfaces.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="panel-group" id="shorthelp">
    <div class="panel panel-default">
      ...
      <div id="shorthelpbody" class="panel-collapse collapse in">
        <div class="panel-body">
          <p>To access Pydio on your Drobo click the &quot;Go to App&quot; button above.</p>
          <p>To ensure data privacy, Pydio is only accessible over HTTPS. If no SSL certificates are available, Pydio will automatically generate a self-signed certificate. <strong>Using self-signed certificates will cause warnings from some web browsers:</strong></p>
          <ul>
          ...
          <p>During the first access Pydio will ask information to configure itself. This information includes:</p>
          <ul>
            <li>An admin account name and password. Please choose a strong password, especially if Pydio will be exposed to the internet.</li>
            <li>Some global options. It is safe to leave these options as they are.</li>
            <li>Storage configuration. For small deployments, please choose storage type &quot;Database&quot;, and select database &quot;Sqlite 3&quot;. Click &quot;Try connecting to the database&quot; and make sure you get a green alert indicating &quot;Connection established!&quot;.</li>
            <li>Optionally include some additional users. This can be done later in Pydio.</li>
          </ul>
          <p>To start answering these configuration questions, click the &quot;Start Wizard!&quot; link on that page.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="panel-group" id="moreinfo">
    <div class="panel panel-default">
      ...
      <div id="moreinfobody" class="panel-collapse collapse in">
        <div class="panel-body">
          <p>Information about creating users, sharing files and folders can be found in the <a href="<?php echo $apphelp; ?>" target="_new">Pydio User guides page</a>.</p>
          <p>Pydio has mobile clients for both <a href="https://play.google.com/store/apps/details?id=com.pydio.android.Client" target="_new">Android</a> and <a href="https://itunes.apple.com/us/app/pydio/id709275884" target="_new">iOS</a>, and a desktop client called <a href="https://pyd.io/apps/pydio-sync/" target="_new">PydioSync</a> for Windows, OS X, and Linux.</p>
          <p>A few extra steps are necessary to connect to Pydio on your Drobo using a mobile app or the desktop client from outside your home network. Those are:</p>
          <ol>
    ...
    <div class="panel panel-default">
      ...
      <div id="summarybody" class="panel-collapse collapse">
        <div class="panel-body">
          ...
          <ol>
            <li>Pydio 6.0.8 (<a href="https://pyd.io/pydio-core-6-0-8/" target="_new">full changelog</a>).</li>
          </ol>
        </div>
      </div>
    </div>
