...
Check the [releases](https://github.com/droboports/pydio/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/pydio.git
cd pydio
./build.sh
ls -la *.tgz
```
